...
const S = {
    ...
    pendingHeadTitle: { fontFamily:"Syne,sans-serif", fontSize:15, fontWeight:700, color:"#ffb347" },
    pendingBadge: { background:"rgba(255,179,71,0.15)", color:"#ffb347", fontSize:11, fontWeight:700, padding:"3px 10px", borderRadius:10 },
    ...
    doctorMeta: {
        ...
        gap:8, paddingTop:12, borderTop:"1px solid rgba(255,255,255,0.05)",
    },
    ...
    listItemIcon: { width:36, height:36, borderRadius:9, display:"flex", alignItems:"center", justifyContent:"center", fontSize:16 },
    ...
    modalTitle: { fontFamily:"Syne,sans-serif", fontSize:18, fontWeight:800, color:"#e4f2ec", marginBottom:8 },
    ...
    modalCancel: {
        ...
        color:"#7da895", fontSize:13, fontWeight:600,
        cursor:"pointer", fontFamily:"DM Sans,sans-serif",
    },
    modalConfirm: {
        flex:1, padding:11, background:"rgba(255,77,109,0.15)",
        border:"1px solid rgba(255,77,109,0.3)", borderRadius:10,
        color:"#ff4d6d", fontSize:13, fontWeight:600,
        cursor:"pointer", fontFamily:"DM Sans,sans-serif",
    },
}
    ...
    const handleApprove = async (id) => {
        try {
            ...
            if (res.ok) {
                ...
                showMsg("✅ Doctor approved successfully.")
            }
        } catch (err) {
            ...
            <div style={S.inner}>
                ...
                {actionMsg && (
                    <div style={{
                        ...
                        borderRadius:10, padding:"12px 18px", fontSize:13, color:"#0dce8f", marginBottom:20,
                    }}>
                        {actionMsg}
                    </div>
                )}
                ...
                <div style={S.welcomeBar}>
                    ...
                    <div>
                        ...
                        <div style={S.welcomeTitle}>Admin Dashboard 🛡️</div>
                        <div style={S.welcomeSub}>Manage doctors, patients, and platform activity.</div>
                    </div>
                </div>
              ...
              {pendingDoctors.length} pending
                ...
                {pendingDoctors.length === 0 ? (
                    <div style={{ ...S.pendingCard, borderColor:"rgba(13,206,143,0.2)" }}>
                                ...
                                <div key={doc.id} style={S.doctorRow}>
                                    ...
                                    <div style={S.doctorMeta}>
                                        <div style={S.metaItem}>
                                            Experience
                                            <div style={S.metaVal}>{doc.experience}</div>
                                        </div>
                                        <div style={S.metaItem}>
                                            Clinic
                                            <div style={S.metaVal}>{doc.clinicName}</div>
                                        </div>
                                        <div style={S.metaItem}>
                                            Fee
                                            <div style={S.metaVal}>₹{doc.fee}</div>
                                        </div>
                                        <div style={S.metaItem}>
                                            License
                                            <div
                                                style={{ ...S.metaVal, color:"#0dce8f", cursor:"pointer" }}
                                                onClick={() => window.open(`http://localhost:8080/${doc.licenseUrl}`, "_blank")}
                                            >
                                                View document →
                                            </div>
                                        </div>
                    ...
                    <div>
                        ...
                        <div style={S.card}>
                            <div style={S.cardHead}>
                                ...
                                <span style={{ fontSize:12, color:"#0dce8f", cursor:"pointer" }}>View all →</span>
                            </div>
                            <div style={S.cardBody}>
                                {MOCK_RECENT_USERS.map((u, i) => (
                                    <div key={i} style={S.listItem}>
                                        <div style={S.listItemLeft}>
                                            <div style={{ ...S.listItemIcon, background:u.color }}>{u.icon}</div>
                                            <div>
                                        ...
                                        {u.badge && (
                                            <span style={{
                                                ...
                                                background: u.badge === "NEW" ? "rgba(13,206,143,0.12)" : "rgba(255,179,71,0.12)",
