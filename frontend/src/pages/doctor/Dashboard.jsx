...
const MOCK_APPOINTMENTS = [
    { id:1, patient:"Rahul Sharma", age:28, time:"10:30 AM", type:"General Checkup", status:"CONFIRMED" },
    { id:2, patient:"Priya Patel",  age:35, time:"11:00 AM", type:"Follow-up",        status:"CONFIRMED" },
    { id:3, patient:"Amit Kumar",   age:45, time:"11:30 AM", type:"Consultation",     status:"CONFIRMED" },
]
        ...
        <div style={S.page}>
            <div style={S.inner}>
                ...
                <div style={S.statsRow}>
                    {[
                        { icon:"👥", num:"3",  label:"Patients today" },
                        { icon:"📅", num:"12", label:"This week" },
                        { icon:"✅", num:"48", label:"Total completed" },
                                ...
                                {isPending ? (
                                    ...
                                    <div key={a.id} style={S.apptItem}>
                                        ...
                                        <div style={S.apptInfo}>
                                            <div style={S.apptName}>{a.patient}</div>
                                            <div style={S.apptDetail}>Age {a.age} · {a.time} · {a.type}</div>
                                        </div>
                                        <div style={{
                                            ...S.apptBadge,
